      ...
      <div className={styles.wrapper}>
        ...
        <div className={styles.contentContainer}>
          ...
          <p className={styles.description}>
            We Provide clean, dependable, environmentally friendly, and cost-effective 
            electrical energy to people all over the world in order to save our planet 
            for future generations.
          </p>

          <ul className={styles.features}>
            <li><span className={styles.check}>✔</span> Ground Mounting System</li>
            <li><span className={styles.check}>✔</span> Flat Roof Mounting System</li>
            <li><span className={styles.check}>✔</span> Solar Carport</li>
          </ul>
