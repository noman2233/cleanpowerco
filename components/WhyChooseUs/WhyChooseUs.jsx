...
/> */}
          ...
          <div className={styles.mainFeature}>
            <div className={styles.iconCircle}>
              {/* Custom SVG Wind Turbine Icon */}
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#e2cc45" strokeWidth="1.5">
            ...
            <div className={styles.mainFeatureText}>
              ...
              <p>New limit across the sun powered worth chain become important to help the PV market’s development.</p>
            </div>
          </div>
